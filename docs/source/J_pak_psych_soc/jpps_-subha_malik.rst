...
=============
   ...
   this occurrence\ :sup:`2`. Providing an environment which is
   assisting and cooperative instead of being hostile and abusive will
   greatly improve the working conditions for nurses. This can also
   enhance productivity and performance. Previous studies identified the
   effect of sexual harassment on workplace efficiency and productivity
   of female nurses working in private and government hospitals. The
   results showed that 40.30% faced verbal harassment and 59.25% of
   unmarried female nurses aged 20-29 faced more sexual harassment by
   physicians 37.03% and patients 20.93%\ :sup:`3`.
   ...
   services\ :sup:`4`. At workplace, nurses usually face two types of
   violence including physical and mental. Psychological violence
   comprised of verbal abuse, harassment/ sexual harassment\ :sup:`5`.
   While Physical violence may comprise of various kind of physical
   strikes or attacks including any harmful pressing, hitting, kicking,
   scratching, rummaging, pounding, killing and abusive
   behavior\ :sup:`5`.
   ...
   that have been influencing nurses' professional lives and
   growth\ :sup:`6`. The evidence of recent studies were emphasized in a
...
+-----------------------------------------------------------------------+
| *PAGE 16 APRIL - JUNE 2021 VOLUME 18 NUMBER 2*                        |
+=======================================================================+
+-----------------------------------------------------------------------+
...
------------
   ...
   nurses participated in the focus group discussion, 10 each from
   public and private hospitals.

Instruments
-----------

   “Sexual Harassment Experience Questionnaire” comprising of 35 items
   and .94 internal reliability was used for data collection\ :sup:`5`.
   Questionnaire was filled up by 125 participants from public hospital
   nurses (MAYO Hospital and Sir Ganga Ram Hospital) while 125 from
   private hospital nurses (Akram Medical Complex Hospital and Surgimed
   Hospital) of Lahore\ **.** In qualitative phase, two focus group
   discussions based on self-constructed questionnaire were carried out
...
=======
   ...
   Demographic information of the nurses working in public and private
   hospitals is given in table 1. Table 2 showed two independent sample
   t-test applied to examine the differences between nurses working in
   public and private hospitals, on the basis of Gender Harassment (GH),
   Sexual Attention (SA) and Sexual Coercion (SC). Private sector nurses
   faced *(M=10.34, S.D=3.39)* more GH than public sector nurses
...
|    **Age range**   |    f       | %         | f         | %         |
+--------------------+------------+-----------+-----------+-----------+
|    20-25           |    54      | 43.2      | 58        | 46.4      |
+--------------------+------------+-----------+-----------+-----------+
|    26-30           |    50      | 40        | 54        | 43.2      |
+--------------------+------------+-----------+-----------+-----------+
|    31-35           |    21      | 16.8      | 13        | 10.4      |
+--------------------+------------+-----------+-----------+-----------+
|    **Marital       |    60      | 48        | 57        | 45.6      |
|    Status**        |            |           |           |           |
|                    |            |           |           |           |
|    Single          |            |           |           |           |
+--------------------+------------+-----------+-----------+-----------+
|    married         |    65      | 52        | 68        | 54.4      |
+--------------------+------------+-----------+-----------+-----------+
|    **Income**      |    0       | 0         | 86        | 68.8      |
|                    |            |           |           |           |
|    10,000-15,000   |            |           |           |           |
+--------------------+------------+-----------+-----------+-----------+
|    16,000-20,000   |    46      | 36.8      | 39        | 31.2      |
+--------------------+------------+-----------+-----------+-----------+
|    21,000-25,000   |    78      | 62.4      | 0         | 0         |
+--------------------+------------+-----------+-----------+-----------+
|    26,000-30,000   |    1       | 0.8       | 0         | 0         |
+--------------------+------------+-----------+-----------+-----------+
...
|                  |        |              |      |      |      | ** |
+------------------+--------+--------------+------+------+------+----+
|    **GH**        | 10.34  |    3.39      | 9.16 |      | 2.76 | .0 |
|                  |        |              |      | 3.37 |      | 06 |
+------------------+--------+--------------+------+------+------+----+
|    **SA**        | 29.8   |    8.24      | 27.5 | 1    | 1.92 | .0 |
|                  |        |              |      | 0.22 |      | 55 |
+------------------+--------+--------------+------+------+------+----+
|    **SC**        | 9.38   |    2.95      | 8.42 |      | 2.54 | .0 |
|                  |        |              |      | 3.01 |      | 12 |
+------------------+--------+--------------+------+------+------+----+

*APRIL - JUNE 2021 VOLUME 18 NUMBER 2 PAGE 17*
...
+-------+----------------------+-------------------------------+------+
|    *  |    **Private         |    **Emerging Themes**        |    * |
| *Main |    Hospital**        |                               | *No. |
|       |                      | **No. of**                    |      |
|   The |                      |                               | of** |
| mes** |                      | **Codes Public Hospital**     |      |
|       |                      |                               | *    |
|       |                      | **131**                       | *Cod |
|       |                      |                               | es** |
|       |                      |                               |      |
...
Insulting/Impolite attitude 5

Yelling/High volume of patients 6

No Reward for hard work 3

**Factors** Interruptions/ Insulting Behavior from 7

Non hierarchal system 7

**affecting** Attendees

Gender Inequality in preference for 7

**performance** Bullying 5

male staff or pay structure

Threaten if not listen to attendants 6

Excessive Workload from Management 5

Misbehavior from Male Staff 5

+--------+----------------------+-----+---------------------------+---+
| **Lack | No separate          | 5   |    Administration is not  | 8 |
| of     | room/washroom        |     |    working                |   |
| facili |                      | 5   |                           |   |
| ties** | Timing issues        |     |    No separate room       |   |
|        |                      |     |    Irresponsible security |   |
|        | Lack of staff/       |   8 |                           | 7 |
|        | irregular staff      |     |    personnel              |   |
|        |                      | 10  |                           |   |
|        | Low wages            |     |    Lack of updated        |   |
|        |                      |     |    Medical Instruments    |   |
|        | No complaint cell    |   8 |                           | 7 |
|        |                      |     |    Lack of Air            |   |
|        | Lack of Daycare      |     |    Conditioning           |   |
|        | facilities           |   6 |                           |   |
|        |                      |     |    No complaint cell      |   |
|        | Job Insecurity       |     |                           | 5 |
|        |                      |   6 |    Lack of Daycare        |   |
|        | Lack of policy       |     |    facilities             |   |
|        | framework            |     |                           |   |
|        |                      |   6 | Better in joint family    |   |
|        | Lack of maternity    |     | system                    | 7 |
|        | leave                |     |                           |   |
|        |                      |   8 |                           |   |
|        |                      |     |                           |   |
|        |                      |     |                           |   |
...
+--------+------------------------+---+--------------------------+---+
|        | Active Administration  | 4 | Casual leave structure   |   |
|   **Co |                        |   |                          |   |
| ping** |    24/7 Security       |   | Maternity leave          |   |
|        |    service             |   |                          | 8 |
|        |                        |   |                          |   |
|  **Tac |                        | 6 |                          |   |
| tics** |                        |   |                          |   |
...
|        |                        |   |                          | 8 |
+========+========================+===+==========================+===+
|    **  |    Poor public         |   | Poor public perception   | 8 |
| Social |    perception          |   |                          |   |
|    &** |                        |   | Dual burden              |   |
|        |    Dual burden         | 8 |                          |   |
|    **  |                        |   | Difficulty in social     |   |
| Family |    Financial crisis    |   | mobility                 | 9 |
|        |                        |   |                          |   |
| life** |                        |   |                          |   |
|        |                        | 8 |                          |   |
|        |                        |   |                          |   |
...
==========
   ...
   Quantitatively issues including gender harassment (verbal/ nonverbal
   behavior i.e. insulting, hostile, degrading and sexist attitudes),
   unwanted sexual attention (verbal/ non-verbal behavior i.e. repeated/
   non-reciprocal request for dates, intrusive letters/ phone calls,
   touching & grabbing) and sexual coercion (promotional benefits on
   sexual cooperation i.e. bribes and threats) were found present for
   both nurses of public and private hospitals. However private hospital
   nurses have been facing significantly more harassment related
   challenges of GH & SC. The findings of the present study are
   supported by literature in which 65.8% nurses experienced unwanted
   sexual attention in different ways\ :sup:`8.` Another study
   identified that female nurses reported 60% and male nurses reported
   34% incident of sexual harassment\ :sup:`9`. It was also seen that
   55.8% of nurses were sexually harassed by their patients and they
   were not able to stop them because of their professional duty to
   respond to them respectably\ :sup:`10.` Another study showed that
   37.1% of nurses had been sexually harassed and 80% of nurses never
   reported the incident of sexual harassment\ :sup:`11` .
   ...
   not cooperative; we only do this job, as there are few other
   opportunities"* and another reported that, *"Management is not good,
   it makes us feel inferior"* however they had better facilities
   including good salary, as compared with nurses working in private
   hospitals but they also reported more issues of hostility. A nurse
   from public hospital reported that, *“Patient's talking style is very
   rude, disrespectful, sexist and bossy”.* While private hospital
   nurses discussed about sexual harassment that influenced their
   professional life. A participant said that, *“There is a harassment
   issue from male colleagues”.* A study supported these findings
   revealing that intimidating behaviors faced by nurses is associated
   with their lower psychological health\ :sup:`12`. Conducts of
   ...
   special protocol and attention to the patients their
   attendants/relatives threaten us”*.
   ...
   workload as well as the quality of patient care\ :sup:`13`. A
   research was conducted to aware patients regarding their rights and
   enhance their satisfaction level via patient's rights
   charter\ :sup:`12`.From private hospital a respondent said that,
   *"They were hired to meet opportunities and other benefits but
   hospital does not preserve equality between men and women”.*
   Different participants reported that, *"Although management often
...
*PAGE 18 APRIL - JUNE 2021 VOLUME 18 NUMBER 2*
   ...
   *patriarchal society where the boss is a male”. "Equality should
   ...
   increased job satisfaction, better nursing staff and work environment
   :sup:`1 4` . As far as implementation of policies is concerned a
   ...
   appropriately due to lack of staff and limited resources\ :sup:`14`.
...
==========
   ...
   |image1|\ |image2|\ |image3|\ The study highlighted issues of
...
6.  Mayhew C. Occupational violence risk for precariously employed
    ...
    Policy and Practice in Health and Safety, 2004; 2(2): 524.
...
14. Tjoflåt I, John Melissa T, Mduma E, Hansen BS, Karlsen B, Søreide E.
    How do Tanzanian hospital nurses perceive their professional role? A
    qualitative study. Nursing open. 2018; 5(3): 323-328.
