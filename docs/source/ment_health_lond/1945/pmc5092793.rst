...
:Author:  J. H. Panton, Vice-Principal, 
...
with childrens' learning, which often baffle and discourage the inexperienced. Generally speaking, the
...
that no bibliography for rather wider reading is provided: instead we have to rely on references in the
