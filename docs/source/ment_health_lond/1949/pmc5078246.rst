...
:Author: T. A. RATCLIFFE, M.A., M.B., D.P.M., D.C.H., and E. V. JONES (Psychiatric Social Worker)
...
agricultural, and characterized by small, widelyscattered villages with poor intercommunications. The area includes also a small port and
...
large industrial city were covered by the psychiatric social workers of the city Mental Hospital
...
was to participate fully in the team, the psychiatrist must have clinical access to the case
material. In a widely scattered region such as
this, with numerous widely separated clinics
under different authorities, actual clinical contact with every patient had obvious difficulties.
...
single active therapeutic interview, the Consulting Psychiatrist arranged, within the framework of the team service, to see the patient
...
acceptance of treatment. Such special interviews might at first seem to cut across the
...
now viewed in a much more realistic and satisfactory light. In all cases, with the patient's
...
refused, and usually the suggestion was welcomed. A copy of the psychiatrist's report was
...
The main source of patients to the organization was from the Service Hospitals, though, as
...
patient, and his agreement obtained on postdischarge of after-care. A report from this
interviewing P.S.W., and a hospital report,
Were normally available to the regional organization, but usually there was no preliminary
...
clinic or hospital. In the latter type of organization the patient, and to a lesser extent his
...
by the case worker who was to conduct aftercare. The home background to which he was
...
from his invaliding. The psychological readjustment problems of the post-release period
...
deal of preliminary suspicion or even antagonism. But, if this was the difficulty, it represented
also the need for such a type of contact, whilst
the strength and value of it, once well established, was very great. Very frequently patients
...
motivation is the often unrecognized identification of future treatment facilities with the
...
an authoritarian order or being given " charitable " or " good " advice. This technically
acquired ability to build up a mature relationship
in which the worker can both " give " and
" not give " as the total situation demands, isthe essential criterion of psychiatric social work,
...
patient himself, her second and equally important task is with the patient's immediate
environment.
...
in some cases the case worker/relatives' relationship assumes greater importance than that with
...
Even if the patient is already receiving treatment, the need will still remain for an unhurried,
...
therapeutic weapon in handling such problems.
...
is more difficult to define or delimit. Technically the relationship which she builds up with
