...
to the sub-normal and moron groups with personality problems, who form the main social problem
...
environmentally conditioned and socially maladjusted types.

As distinct from the chapters devoted entirely to
testing technique, the last chapter on Psychotherapy
has a simple, human approach which every institutional worker should take to heart. It is not a
feature of most books on the subject.

As in most American work, there is an overattention to the pinpoint diagnosis of defect by the
...
Dr Sarason's statement (p. 107) that " the institutional setting seldom provides conditions of learning
